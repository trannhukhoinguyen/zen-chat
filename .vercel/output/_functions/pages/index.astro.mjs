...
const id = "foodies";
const title = "Foodies";
const description = "A project that uses image processing and OCR to restore faded English text from historical documents. It applies multiple enhancement steps, uses Tesseract OCR, and refines results via Gemini LLM.";
...
const images = [{"url":"https://private-user-images.githubusercontent.com/92692198/381748439-2bb2b8cf-4288-4cb6-97ec-094c88633e41.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..pbU3d-CpjnIPwZq6WojaDN7vIWJ1uxOo3kdB2Hgjmww","alt":"Foodies Landing Page"}];
const foodies = {
  id,
  title,
  description,
